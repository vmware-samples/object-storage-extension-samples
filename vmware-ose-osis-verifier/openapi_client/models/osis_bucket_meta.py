...
class OsisBucketMeta(BaseModel):
    """
    OsisBucketMeta
    """ # noqa: E501
    name: StrictStr = Field(description="Bucket name.")
    creation_date: datetime = Field(description="Bucket creation date.")
    user_id: StrictStr = Field(description="ID of bucket owner.")
    __properties: ClassVar[List[str]] = ["name", "creation_date", "user_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OsisBucketMeta from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OsisBucketMeta from a dict"""
        if obj is None:
            return None
