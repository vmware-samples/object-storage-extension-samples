...
class PageOfTenants(BaseModel):
    """
    PageOfTenants
    """ # noqa: E501
    items: Optional[List[OsisTenant]] = None
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PageOfTenants from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of PageOfTenants from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "items": [OsisTenant.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
