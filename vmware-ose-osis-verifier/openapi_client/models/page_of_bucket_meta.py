...
class PageOfBucketMeta(BaseModel):
    """
    PageOfBucketMeta
    """ # noqa: E501
    items: Optional[List[OsisBucketMeta]] = None
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PageOfBucketMeta from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of PageOfBucketMeta from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "items": [OsisBucketMeta.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
            "page_info": PageInfo.from_dict(obj.get("page_info")) if obj.get("page_info") is not None else None
        })
        return _obj
