...
class PageOfUsers(BaseModel):
    """
    PageOfUsers
    """ # noqa: E501
    items: Optional[List[OsisUser]] = None
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PageOfUsers from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of PageOfUsers from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "items": [OsisUser.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
