...
class OptionalApi(object):
    ...
    def get_anonymous_user(self, **kwargs):  # noqa: E501
        """Get the anonymous user id and name of the platform  # noqa: E501

        Operation ID: getAnonymousUser<br> Get the anonymous user id and name of the platform   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_anonymous_user(async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_anonymous_user_with_http_info(**kwargs)  # noqa: E501

    def get_anonymous_user_with_http_info(self, **kwargs):  # noqa: E501
        """Get the anonymous user id and name of the platform  # noqa: E501

        Operation ID: getAnonymousUser<br> Get the anonymous user id and name of the platform   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_anonymous_user_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_anonymous_user" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
    ...
    def get_bucket_logging_id(self, **kwargs):  # noqa: E501
        """Get the bucket logging id of the platform  # noqa: E501

        Operation ID: getBucketLoggingId<br> Get the bucket logging id of the platform   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_bucket_logging_id(async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_bucket_logging_id_with_http_info(**kwargs)  # noqa: E501

    def get_bucket_logging_id_with_http_info(self, **kwargs):  # noqa: E501
        """Get the bucket logging id of the platform  # noqa: E501

        Operation ID: getBucketLoggingId<br> Get the bucket logging id of the platform   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_bucket_logging_id_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_bucket_logging_id" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
    ...
    def get_console(self, **kwargs):  # noqa: E501
        """Get the console URI of the platform or platform tenant  # noqa: E501

        Operation ID: getConsole<br> Get the console URI of the platform or platform tenant if tenantId is specified   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_console(async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str tenant_id: The ID of the tenant to get its console URI
        :param str lang: The language of console page to show
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_console_with_http_info(**kwargs)  # noqa: E501

    def get_console_with_http_info(self, **kwargs):  # noqa: E501
        """Get the console URI of the platform or platform tenant  # noqa: E501

        Operation ID: getConsole<br> Get the console URI of the platform or platform tenant if tenantId is specified   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_console_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def get_usage(self, **kwargs):  # noqa: E501
        """Get the usage of the platform tenant or user  # noqa: E501

        Operation ID: getUsage<br> Get the platform usage of global (without query parameter), tenant (only with tenant_id) or user (with tenant_id and user_id).   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool: execute request asynchronously
        :param str tenant_id: The ID of the tenant to get its usage.
        :param str user_id: The ID of the user to get its usage.
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def get_usage_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(OsisUsage, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='OsisUsage',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
